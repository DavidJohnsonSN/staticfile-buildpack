...
This fork uses OpenResty 1.11.2.4, which provides Lua support.
...
curl -sSL https://openresty.org/download/openresty-1.11.2.4.tar.gz | tar xzf -
...
sudo make install
tar czvf nginx-1.11.2.4.tgz -C /home/vcap/app .
```
